...
image:https://github.com/apache/ofbiz-framework/actions/workflows/gradle.yml/badge.svg?branch=trunk[link=https://github.com/apache/ofbiz-framework/actions/workflows/gradle.yml]
